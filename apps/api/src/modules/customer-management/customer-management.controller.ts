...
@Controller('users') @UseGuards(AccessTokenGuard,RolesGuard) @Roles('CUSTOMER')
...
@Controller('addresses') @UseGuards(AccessTokenGuard,RolesGuard) @Roles('CUSTOMER')
...
@Controller('wholesale') @UseGuards(AccessTokenGuard,RolesGuard) @Roles('CUSTOMER')
